...
function Navbar() {
  ...
  const StatBtn = [
    {
      title: "Wind Speed",
      link: "/WindSpeedStats", // Updated link value
    },
    {
  ...
  return (
    <div className="opacity-100 md:opacity-100 z-100 absolute flex flex-row group z-50">
      ...
      <div id="RAWR"
        className={`transition-all duration-200 mt-3 w-[15vw] h-[100vh] bg-[#212121] ${
          showWow ? "" : "hidden"
        }`}
      >
        <section id="Hakdog" className="flex flex-col mt-3 items-center justify-center overflow-y-auto">
