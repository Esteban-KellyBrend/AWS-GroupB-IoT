...
function COValueStats() {
  ...
  const firebasefolder = "MQ-7 Sensor";
  ...
  return (
    <div className="bg-gradient-to-tr to-[#431857] from-black from-30% bg-cover absolute h-screen w-screen">
      ...
      <LineGraph data={datavalue} labels={filtereddatakey} name={"HOURLY"} unit="ppm" dataLimit={14} />
      <LineGraph data={weeklyData} labels={weeklyLabels} name={"WEEKLY"} unit="ppm" dataLimit={7} />
