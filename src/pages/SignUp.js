        ...
        <div className="bg-gradient-to-tr to-[#431857] from-black from-30% bg-cover absolute h-screen w-screen" >
            <div className="login flex-col max-w-2xl mt-24 ml-9 flex-grow items-center justify-start text-[#C5A4D5] w-1/2">
                ...
                <div className="input-box mt-11 w-80 border-b-4 border-[#813DAE]">
                    <input type="text" className="w-90 border-none outline-none bg-transparent text-[#C5A4D5] text-2xl" placeholder="First Name" />
                </div>

                <div className="input-box mt-11 w-80 border-b-4 border-[#813DAE]">
                    <input type="text" className="w-90 border-none outline-none bg-transparent text-[#C5A4D5] text-2xl" placeholder="Last Name" />
                </div>

                <div className="input-box mt-11 w-80 border-b-4 border-[#813DAE]">
                    <input type="text" className="w-90 border-none outline-none bg-transparent text-[#C5A4D5] text-2xl" placeholder="Username" />
                </div>
