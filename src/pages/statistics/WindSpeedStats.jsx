...
function WindSpeedStats() {
  ...
  const firebasefolder = "Wind Speed Sensor";
  ...
  const filtereddatakey = formatDataKeys(datakey, "HHMM", true, "12hour");
  ...
  return (
    <div className="bg-gradient-to-tr to-[#431857] from-black from-30% bg-cover absolute h-screen w-screen">
      ...
      <LineGraph data={datavalue} labels={filtereddatakey} name={"HOURLY"} unit="kph" dataLimit={14} />
      <LineGraph data={weeklyData} labels={weeklyLabels} name={"WEEKLY"} unit="kph" dataLimit={7} />
