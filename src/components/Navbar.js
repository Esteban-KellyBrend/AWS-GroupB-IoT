    ...
    <div className="opacity-0 md:opacity-100 z-100 absolute flex flex-row group">
      ...
      <div className={`transition-all duration-200 mt-3 w-[15vw] h-[100vh] bg-[#212121] ${showWow ? "" : "hidden"}`}>
        ...
        {StatBtn.map((btn, index) => (
          <Link to={btn.link} className="w-[90%] h-[8vh] border border-[#626262] border-opacity-60 hover:bg-[#9E7FA9] hover:text-opacity-100 text-white  text-opacity-50 hover:bg-opacity-20 hover:border-white hover:border-opacity-50">
