...
function TemperatureStats() {
  ...
  const firebasefolder = "DHT22/Temperature";
  ...
  return (
    <div className="bg-gradient-to-tr to-[#431857] from-black from-30% bg-cover absolute h-screen w-screen">
      ...
      <LineGraph data={datavalue} labels={filtereddatakey} name={"HOURLY"} unit="°C" dataLimit={14} />
      <LineGraph data={weeklyData} labels={weeklyLabels} name={"WEEKLY"} unit="°C" dataLimit={7} />
