      ...
      >
        <section className="flex flex-col mt-3 items-center justify-center overflow-y-auto">
          {StatBtn.map((btn, index) => (
            <Link to={btn.link} className="w-[90%] h-[8vh] border border-[#626262] border-opacity-60 hover:bg-[#9E7FA9] hover:text-opacity-100 text-white  text-opacity-50 hover:bg-opacity-20 hover:border-white hover:border-opacity-50 pt-2">
